...
urlpatterns = [
    ...
    path('documento/<str:id>',documento,name='documento'),
    ...
    path('elim_pago/<str:ad>/<str:num>', elim_pago, name='elim_pago'),
    ...
    path('administrador/agregar_articulo/', agregar_articulo),
]
